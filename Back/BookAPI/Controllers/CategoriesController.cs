...
namespace BookAPI.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCategory(int id, EncryptedPayload payload)
        {
            try
            {
        ...
        public async Task<ActionResult<EncryptedPayload>> PostCategory(EncryptedPayload payload)
        {
            try
            {
                ...
                if (CategoryNameExists(model.CategoryName, 0))
                {
                    return BadRequest("Name already exists");
                }
        ...
        {
            return _context.Categories.Any(bc => bc.CategoryName == name && bc.CategoryId != id);
        }
    }
}
